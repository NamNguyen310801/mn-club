...
import { createDepartmentAPI } from "@/app/_utils/services/department.api";
import { setIsGetDepartmentList } from "@/app/_utils/store/manager.slice";
export default function DepartmentsTop() {
  ...
  const createDepartment = async () => {
    ...
    if (res?.status == 200) {
      toast("Thêm mới phòng ban thành công");
      dispatch(setIsGetDepartmentList(!isGetDepartmentList));
    } else {
      toast("Thêm mới phòng ban thất bại");
    }
  };
  return (
